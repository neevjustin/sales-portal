// ==============================================================================
// File: frontend/src/pages/ManagementPortal.tsx (Updated)
// ==============================================================================
...
import { ScoringManagementView } from '../components/management/ScoringManagementView'; // <-- IMPORT
...
export const ManagementPortal = () => {
    ...
    return (
        <div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-6">Management Portal</h1>
            <div className="mb-6 border-b border-gray-200 dark:border-gray-700">
                <nav className="-mb-px flex space-x-6 overflow-x-auto">
                    {isAdmin && (
                        <>
                            <NavLink to="/management/ba-targets" className={getNavLinkClass}>BA Targets</NavLink>
                            <NavLink to="/management/scoring" className={getNavLinkClass}>Scoring</NavLink> {/* <-- ADD LINK */}
                        </>
                    )}
                    {!isAdmin && (
                        <>
                            <NavLink to="/management/teams" className={getNavLinkClass}>Teams & Members</NavLink>
            ...
            <Routes>
                {isAdmin && (
                    <>
                        ...
                        <Route path="scoring" element={<ScoringManagementView />} /> {/* <-- ADD ROUTE */}
                    </>
                )}
                {!isAdmin && (
                    <>
                ...
                <Route index element={<Navigate to={isAdmin ? "ba-targets" : "teams"} replace />} />
            </Routes>
        </div>
    );
};